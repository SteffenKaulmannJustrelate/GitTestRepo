// Last Update by user CUSTOMIZER at 20171212093400
import de.pisa.psa.frm.psa_art.*;
import de.pisa.psc.srv.gui.*;

/** PSA_ART_SML_HFIL_PRJ_SSC */
public class IplDlgPsaArtSmlHfilPrjSsc extends PsaArtApp {

	public IplDlgPsaArtSmlHfilPrjSsc(String s) {
		super(s);
	}
