// Last Update by user CUSTOMIZER at 20171211125002
...
/**
 * DMO_PSA_CAL_GEN_SSC dialog implementation
 */
public class IplDlgDmoPsaCalGenSsc extends PsaCalApp {

	/**
	 * common constructor
	 * @param dsc dialog descriptor
	 */
	public IplDlgDmoPsaCalGenSsc(String dsc) {
		super(dsc);
	}
